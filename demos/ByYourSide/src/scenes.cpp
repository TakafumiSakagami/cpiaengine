    ...
    void gardeninghub()
    {
        if (garden <= "1")
        {
              ...
              if(true)
                ...
                bn::string_view dialogue_text_lines[] = {
                    "",
                    "She points to a small",
                    "potted plant covered in",
              ...
              if(true)
                ...
                bn::string_view dialogue_text_lines[] = {
                    "You",
                    "Pffft, the seeds will roll",
                    "in fear when they hear me",
                    "come.|",
                    "",
                    "",
                    };
...
///////////////////////////////////////////////////////////   
    ...
    if(workflag = "Boats")
      ...
      if(true)
          ...
          bn::string_view dialogue_text_lines[] = {
              "",
              "I remember hearing they",
              "have an old boat in the",
              "museum here, so I should",
              "check it out.|",
              "",
              "",
              };
    ...
    if(workflag = "Squirrel")
      ...
      if (day >= "32" & day32scene == "0")
            ...
            if(true)
              ...
              bn::string_view dialogue_text_lines[] = {
                  "Euon",
                  "Hey, a fairy's strongest",
                  "trait is their ability to",
                  "communicate!|",
                  "",
                  "",
                  };
            ...
            if(true)
              ...
              bn::string_view dialogue_text_lines[] = {
                  ...
                  "sight, but you were a far",
                  "cry from conquerors of the",
                  "planet.|",
                  "",
                  "",
                  };
