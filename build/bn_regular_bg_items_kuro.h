...
#define kuro_bn_gfxTilesLen 96
extern const bn::tile kuro_bn_gfxTiles[3];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item kuro(
            regular_bg_tiles_item(span<const tile>(kuro_bn_gfxTiles, 3), bpp_mode::BPP_4, compression_type::NONE), 
